...
public class BasicCaching implements CachingSystem {
    ...
    private static final long REASONABLE_DISK_SIZE = 1024 * 1024 * 100; // 1 MB
    ...
    public static BasicCaching fromCtx(Context context) {
        ...
        return new BasicCaching(
                new File(context.getCacheDir(), AppUtils.AppFileName
                        + File.separator + AppUtils.AppFileNameFileDir),
