 ...
 * 分割线
 */
public class SlideRecycleViewItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SlideRecycleViewItemDecoration(Context context, int orientation) {
     ...
     * @return
     */
    public SlideRecycleViewItemDecoration setMarginLeftDP(int dp) {
        leftMargin = dp;
        return this;
    }
     ...
     * @return
     */
    public SlideRecycleViewItemDecoration setMarginRightDP(int dp) {
        this.rightMargit = dp;
        return this;
    }
