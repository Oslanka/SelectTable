...
public class MySpannableTextView extends AppCompatTextView {
    ...
    public void init(int maxFirstShowCharCount) {
        limitTextViewString(this.getText().toString(), maxFirstShowCharCount, this, new OnClickListener() {
            @Override
    ...
    public MySpannableTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MySpannableTextView, defStyleAttr, 0);
        max_char_count = a.getInteger(R.styleable.MySpannableTextView_maxCharCount, 50);
        init(max_char_count);
    }
...
//返回-1表示没有达到行数限制
        ...
        mSpanALL.setSpan(new ClickableSpan() {
            ...
            public void updateDrawState(TextPaint ds) {
                ...
                ds.setColor(textView.getResources().getColor(R.color.moreTextColor));
