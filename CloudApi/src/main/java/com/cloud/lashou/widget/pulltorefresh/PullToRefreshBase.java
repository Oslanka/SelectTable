 ...
 *******************************************************************************/
package com.cloud.lashou.widget.pulltorefresh;
...
import com.cloud.lashou.widget.pulltorefresh.internal.FlipLoadingLayout;
import com.cloud.lashou.widget.pulltorefresh.internal.LoadingLayout;
import com.cloud.lashou.widget.pulltorefresh.internal.RotateLoadingLayout;
import com.cloud.lashou.widget.pulltorefresh.internal.Utils;
import com.cloud.lashou.widget.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private boolean isLoadAvailable = true; //DM：该flag为了判断当前列表已完全展示、正在上拉等不需要下拉的情况
	// ===========================================================
	// Fields
	// ===========================================================
...
//		handlerSteepListener(event);
		...
		if(!isLoadAvailable && mCurrentMode == Mode.PULL_FROM_END){
			return true;
		}
